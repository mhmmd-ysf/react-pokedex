...
function Details(props) {
  ...
  return (<div>
    <div className="flex justify-center p-3 space-x-10 md:p-10">
      ...
      {/* Kanan - Details */}
      <div className="hidden my-2 text-left md:block">
        {/* Weakness */}
        ...
        <h1 className="mt-5 text-2xl font-bold">Attacks</h1>
        {/* Fast Attacks */}
        <div className="flex items-center space-x-3">
          <p>
            Fast
        ...
        <h1 className="mt-5 text-2xl font-bold">Height & Weight</h1>
        ...
        <h1 className="mt-5 text-2xl font-bold">Evolutions</h1>
    ...
    {/* Details Mobile */}
    <div className="p-5 my-4 text-left md:hidden">
      {/* Weakness */}
      <h1 className="text-2xl font-bold">Weaknesses and Resistances</h1>
      <div className="flex items-center space-x-3">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
      ...
      <h1 className="mt-5 text-2xl font-bold">Fast & Special Attacks</h1>
      {/* Fast Attacks */}
      <div className="flex items-center space-x-3">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-yellow-300" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
      ...
      <h1 className="my-2 text-2xl font-bold">Height & Weight</h1>
